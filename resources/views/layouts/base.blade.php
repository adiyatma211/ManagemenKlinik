                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item  ">
                                    <a href="component-alert.html" class="submenu-link">Presensi</a>
                                </li>
                                <li class="submenu-item  ">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="component-accordion.html" class="submenu-link">Jadwal Dokter</a>
                                </li>
                                <li class="submenu-item  ">
                                    <a href="component-alert.html" class="submenu-link">Reservasi</a>
                                </li>
                                <li class="submenu-item  ">
                                    <a href="component-alert.html" class="submenu-link">Konfirmasi Kehadiran</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="component-accordion.html" class="submenu-link">Report Alat Medis</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="component-alert.html" class="submenu-link">Management Alat Medis</a>
                                </li>
