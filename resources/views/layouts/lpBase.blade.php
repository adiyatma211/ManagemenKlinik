...
<head>
    ...
    <!-- CSS here -->
    <link rel="stylesheet" href="{{ asset('lpUser/assets/css/vendor/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('lpUser/assets/css/vendor/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('lpUser/assets/css/plugins/swiper.min.css') }}">
    <link rel="stylesheet" href="{{ asset('lpUser/assets/css/vendor/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('lpUser/assets/css/vendor/fontawesome-pro.css') }}">
...
<![endif]-->
                ...
                <div class="offcanvas__content">
                    <div class="offcanvas__top d-flex justify-content-between align-items-center">
                        <div class="offcanvas__logo">
                            <a href="index.html">
                                <img src="{{ asset('lpUser/assets/imgs/logo/logo-white.svg') }}" alt="logo not found">
                            </a>
                        </div>
            ...
            <div class="container">
                <div class="row mb-minus-30">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="service__item mb-30">
                            <div class="service__item-icon mb-20 mb-xs-15">
                                <img src="{{ asset('lpUser/assets/imgs/service/service__item-1.png') }}"
                                    alt="icon not found">
                            </div>

                            <h4 class="mb-25 mb-xs-20"><a href="service-details.html">Harbor Health</a></h4>

                            <p class="mb-40 mb-xs-30">Et purus duis sollicitudin sed dign issim habi tant. Egestas
                                nulla quis venenatis Et purus </p>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="service__item mb-30">
                            <div class="service__item-icon mb-20 mb-xs-15">
                                <img src="{{ asset('lpUser/assets/imgs/service/service__item-2.png') }}"
                                    alt="icon not found">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="service__item mb-30">
                            <div class="service__item-icon mb-20 mb-xs-15">
                                <img src="{{ asset('lpUser/assets/imgs/service/service__item-3.png') }}"
                                    alt="icon not found">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="service__item mb-30">
                            <div class="service__item-icon mb-20 mb-xs-15">
                                <img src="{{ asset('lpUser/assets/imgs/service/service__item-4.png') }}"
                                    alt="icon not found">
                            </div>
        ...
        <section class="about-us section-space overflow-hidden">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-xl-6">
                        <div class="doctor-schedule d-flex flex-column align-items-center justify-content-center">
                            ...
                            <table class="table table-bordered text-center">
                                ...
                                <tbody>
                                    @foreach ($showDokter as $key => $a)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $a->nama_dokter }}</td>
                                            <td>{{ $a->departemen->nama_departemen }}</td>
                                            <td>
                                                {{ $a->jadwal->day_range ?? 'N/A' }}
                                                {{ $a->jadwal->start_time ?? '' }} - {{ $a->jadwal->end_time ?? '' }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="col-xl-6">
                        <div
                            class="about-us__media d-flex flex-column flex-sm-row align-items-sm-start align-items-center justify-content-xl-end justify-content-center">
                            <img class="img-fluid about-us__media-big-shape"
                                src="{{ asset('lpUser/assets/imgs/about-us/shape-big.png') }}" alt="icon not found">

                            <div class="about-us__media-experience-box__wrapper text-end">
                                <div class="about-us__media-img img1">
                                    <img class="img-fluid shape downUp"
                                        src="{{ asset('lpUser/assets/imgs/about-us/shape-2.png') }}"
                                        alt="icon not found">
                                    <img class="img-fluid"
                                        src="{{ asset('lpUser/assets/imgs/about-us/about-us__media-1.jpg') }}"
                                        alt="icon not found">
                                </div>
                            ...
                            <div class="about-us__media-img img2">
                                <img class="img-fluid shape upDown"
                                    src="{{ asset('lpUser/assets/imgs/about-us/shape-1.png') }}"
                                    alt="icon not found">
                                <img class="img-fluid"
                                    src="{{ asset('lpUser/assets/imgs/about-us/about-us__media-2.jpg') }}"
                                    alt="icon not found">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                    ...
                    <div class="col-12">
                        <div class="section__title-wrapper treatment-process__content text-center mb-60 mb-xs-40">
                            ...
                            <p class="mb-0">Medical science encompasses a vast array of fields dedicated to
                                ...
                                Here's a brief exploration into this multifaceted</p>
                        </div>
                ...
                <div class="row mb-minus-30">
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="treatment-process__item mb-30 text-center">
                            <div class="treatment-process__item-icon mb-20 mb-xs-15">
                                <img src="{{ asset('lpUser/assets/imgs/treatment-process/treatment-process__item-1.png') }}"
                                    alt="icon not found">
                            </div>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="treatment-process__item mb-30 text-center">
                            <div class="treatment-process__item-icon mb-20 mb-xs-15">
                                <img src="{{ asset('lpUser/assets/imgs/treatment-process/treatment-process__item-2.png') }}"
                                    alt="icon not found">
                            </div>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="treatment-process__item mb-30 text-center">
                            <div class="treatment-process__item-icon mb-20 mb-xs-15">
                                <img src="{{ asset('lpUser/assets/imgs/treatment-process/treatment-process__item-3.png') }}"
                                    alt="icon not found">
                            </div>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="treatment-process__item mb-30 text-center">
                            <div class="treatment-process__item-icon mb-20 mb-xs-15">
                                <img src="{{ asset('lpUser/assets/imgs/treatment-process/treatment-process__item-4.png') }}"
                                    alt="icon not found">
                            </div>
                    ...
                    @foreach ($departemenList as $departemen)
                        <div class="col-xl-4 col-md-6">
                            <div class="pricing__item mb-30">
                                <!-- Department name as the title -->
                                <h3 class="mb-15 mb-xs-10">{{ $departemen->nama_departemen }}</h3>

                                <!-- Price section (adjust as necessary if you have specific pricing) -->
                                <h2 class="pricing__item-price mb-25 mb-xs-20">
                                    Rp:{{ number_format($departemen->biaya, 0, ',', '.') }} <span
                                        class="body-font"></span>
                                </h2>


                                <!-- Description or additional information -->
                                <p class="mb-20 pb-20 pricing__item__border-bottom">
                                    {{ $departemen->keterangan_departemen ?? 'No description available for this department.' }}
                                </p>

                                <!-- Features or services offered (replace with dynamic data if available) -->
                                {{-- <div class="pricing__item-body">
                                    <ul>
                                        <li><i class="fa-solid fa-angle-right"></i> Example feature 1</li>
                                        <li><i class="fa-solid fa-angle-right"></i> Example feature 2</li>
                                        <li><i class="fa-solid fa-angle-right"></i> Example feature 3</li>
                                        <li><i class="fa-solid fa-angle-right"></i> Example feature 4</li>
                                    </ul>
                                </div> --}}
                                ...
                                <a href="pricing.html" class="rr-btn mt-40 mt-xs-30">
                                    <span class="btn-wrap">
                                        <span class="text-one">Start now <i
                                                class="fa-solid fa-circle-plus"></i></span>
                                        <span class="text-two">Start now <i
                                                class="fa-solid fa-circle-plus"></i></span>
                                    </span>
                                </a>
                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        ...
                                        <div class="testimonial__item-content mb-35 mb-xs-30">
                                            <p class="mb-0">Leverage agile frameworks to provide a robust synopsis
                                                for strategy foster Leverage agile frame works to provide a robust
                                                synopsis for strateg foster collaborative thinking to further</p>
                                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="section__title-wrapper ask-question__content mb-40 mb-xs-30">
                            <h5 class="section__subtitle color-theme-primary mb-15 mb-xs-10 title-animation"><img
                                    src="{{ asset('lpUser/assets/imgs/ask-quesiton/heart.png') }}"
                                    alt="icon not found" class="img-fluid">
                                Ask Question</h5>
                            <h2 class="section__title mb-0 title-animation">Healing Harmony Uniting Care and Compassion
                            </h2>
                        </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p>Lorem Ipsum is simply dummy text the printing and typese Lorem Ipsum has
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="brand__item text-center">
                                        <div class="brand__thumb">
                                            <img class="img-fluid"
                                                src="{{ asset('lpUser/assets/imgs/brand/brand-1.png') }}"
                                                alt="image not found">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brand__item text-center">
                                        <div class="brand__thumb">
                                            <img class="img-fluid"
                                                src="{{ asset('lpUser/assets/imgs/brand/brand-2.png') }}"
                                                alt="image not found">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brand__item text-center">
                                        <div class="brand__thumb">
                                            <img class="img-fluid"
                                                src="{{ asset('lpUser/assets/imgs/brand/brand-3.png') }}"
                                                alt="image not found">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brand__item text-center">
                                        <div class="brand__thumb">
                                            <img class="img-fluid"
                                                src="{{ asset('lpUser/assets/imgs/brand/brand-4.png') }}"
                                                alt="image not found">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="brand__item text-center">
                                        <div class="brand__thumb">
                                            <img class="img-fluid"
                                                src="{{ asset('lpUser/assets/imgs/brand/brand-5.png') }}"
                                                alt="image not found">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row mb-minus-30">
                <div class="col-md-6">
                    <div
                        ...
                        <div class="footer__cta-item-icon d-flex align-items-center justify-content-center">
                            <img class="img-fluid"
                                src="{{ asset('lpUser/assets/imgs/footer__cta/footer__cta-item-1.png') }}"
                                alt="icon not found">
                        </div>

                        <div class="footer__cta-item-text">
                            <h4 class="color-white mb-15 mb-10">Expert Eye Care</h4>
                            <p class="color-white mb-0">Et purus duis sollicitudin dignissim habitant. Egestas nulla
                                quis venenatis cras sed eu massa eu faucibus</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div
                        ...
                        <div class="footer__cta-item-icon d-flex align-items-center justify-content-center">
                            <img class="img-fluid"
                                src="{{ asset('lpUser/assets/imgs/footer__cta/footer__cta-item-2.png') }}"
                                alt="icon not found">
                        </div>
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="footer__widget footer__widget-item-1">
                            <div class="footer__logo mb-30 mb-xs-25">
                                <a href="index.html">
                                    <img class="img-fluid"
                                        src="{{ asset('lpUser/assets/imgs/logo/footer-logo.svg') }}"
                                        alt="logo not found">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="footer__widget footer__widget-item-3">
                            ...
                            <div class="footer__subscribe-content">
                                <p class="mb-30 mb-xs-25">Custom Software Development Tailored Solutions for Your
                                    Business Custom </p>
    ...
    <!-- JS here -->
    <script src="{{ asset('lpUser/assets/js/vendor/jquery-3.7.1.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/waypoints.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/vendor/bootstrap.bundle.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/meanmenu.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/odometer.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/swiper.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/wow.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/vendor/magnific-popup.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/vendor/type.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/nice-select.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/vendor/jquery-ui.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/vendor/jquery.appear.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/parallax.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/parallax-scroll.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/gsap.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/ScrollTrigger.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/SplitText.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/tween-max.min.js/') }}"></script>
    <script src="{{ asset('lpUser/assets/js/plugins/draggable.min.js/') }}"></script>
